...
public class WideLatchEdgeTriggered : LogicElement
{
    private readonly BlockArray<FlipFlopEdgeTriggeredDType> _latches;
    ...
    public WideLatchEdgeTriggered(Int32 width)
    {
        _latches = new BlockArray<FlipFlopEdgeTriggeredDType>(width);
